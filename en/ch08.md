...
(2) **Hide balance:** will display your balance as ?.?? It is a useful feature if you are running your wallet in a public place, like in point of sales systems.  
(3) **Light theme:** Switch between light theme and dark theme.  
(4) **Lock wallet on inacitivity:** Set this to automatically lock your wallet after N minutes of inactivity. This ensures no one is able to use your wallet while you are away from keyboard.  
