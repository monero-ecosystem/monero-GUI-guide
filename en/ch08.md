...
(3) **Hide balance:** Will display your balance as ?.?? It is a useful feature if you are running your wallet in a public place, as a point of sales system.  
(4) **Light theme:** Switch between light and dark themes.  
(5) **Ask for password before sending a transaction:** Disable this option if you don't want to type your password every time a transaction is sent.
...
(8) **Enable displaying balance in other currencies:** Gives you the possibility to display your balance also in other currencies. You can select the price source and the currency you prefer (*USD* or *EUR*).
